...
//       console.error("[FORGOT_PASSWORD] Error sending password reset email:", error);
//       console.error("[FORGOT_PASSWORD] Error code:", error.code);
//       console.error("[FORGOT_PASSWORD] Error message:", error.message);
    ...
    try {
      ...
      if (isFirebaseError(err)) {
        if (err.code === "auth/user-not-found") {
          // Don't reveal the existence of accounts for security
          setIsSubmitted(true);
          toast.success("Password reset email sent. Please check your inbox.");
          return;
        }
