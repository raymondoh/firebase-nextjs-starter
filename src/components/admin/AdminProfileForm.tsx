...
export function AdminProfileForm({ id, onCancel, redirectAfterSuccess = "/admin" }: AdminProfileFormProps) {
  ...
  return (
    <div>
      <form id={id} onSubmit={handleSubmit} className="grid w-full gap-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            required
          />
          <p className="text-sm text-muted-foreground">This is your public display name as an administrator.</p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            placeholder="Tell us a little bit about yourself as an administrator"
            className="resize-none min-h-[100px]"
          />
          <p className="text-sm text-muted-foreground">
            Share a brief description about your role and responsibilities as an administrator.
          </p>
        </div>
      ...
      {isSuccess && <p className="mt-4 text-sm text-green-600">Your admin profile has been updated successfully.</p>}
    </div>
  );
}
