...
/** Delete a user from Firebase Auth, Firestore, and Storage (admin side) */
export async function deleteUserAsAdmin(
  userId: string,
  adminId?: string
): Promise<{ success: true } | { success: false; error: string }> {
...
/** Delete a user from Firebase Auth only */
export async function deleteUser(uid: string) {
  try {
    await adminAuth.deleteUser(uid);
    return { success: true };
...
/** Delete user image given full URL */
...
// ===============================================================
// Firebase User Creation from Token
// ===============================================================

/** Verify ID token and create Firestore user */
export async function verifyAndCreateUser(token: string): Promise<VerifyAndCreateUserResult> {
  try {
    const decodedToken = await adminAuth.verifyIdToken(token);
