...
//           if (provider === "google" && !userId && user.sub) {
//             userId = user.sub;
...
//         try {
//           const result = await syncUserWithFirebase(googleId, {
//             email,
//             name,
//             image,
//             provider: "google",
...
//           console.log("[authOptions] Google user synced successfully:", result);
//         } catch (error) {
//           console.error("[authOptions] Failed to sync Google user with Firebase:", error);
//           // Optionally: throw error to prevent login
//         }
//       }
//     },
//     async signOut(
...
// Define a more comprehensive ExtendedUser type that includes sub property
type ExtendedUser = {
  id?: string;
  sub?: string;
  email?: string;
